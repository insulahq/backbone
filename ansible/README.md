...
| `powerdns_master` | PowerDNS primary + PostgreSQL backend | ns1 |
| `powerdns_slave` | PowerDNS secondary + SQLite, AXFR replication | ns2 |
| `traefik` | Traefik v3.6 reverse proxy, DNS-01 ACME | ns1, ns2 |
