...
| **External DNS**            | **PowerDNS with API** or integrate with **Cloudflare/Route53** | Programmatic DNS record management for client domains |
...
- [FRONTEND_DEPLOYMENT_ARCHITECTURE.md](../FRONTEND_DEPLOYMENT_ARCHITECTURE.md) — Admin/client panel deployment
