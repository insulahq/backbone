...
## ADR-016: Traditional Hosting Deployment Model — FileBrowser, SFTP, Git Pull
...
**Files requiring updates to adopt canonical path layout:**
- `01-core/SHARED_POD_IMPLEMENTATION.md` — `/var/www/acme/` → `/storage/customers/{id}/domains/{domain}/public_html/`
- `01-core/WORKLOAD_DEPLOYMENT.md` — `/mnt/clients/client-{id}/` → `/storage/customers/{id}/`
